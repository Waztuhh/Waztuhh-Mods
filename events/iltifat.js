...
moment.locale("tr");
    ...
    let iltifatlar = [
      ...
      "Vegas senden mesaj bekliyor ;)",
      "Vegas selam söyledi sana.",
      "Vegas yanına gelmek için uçak bileti almış benden duymuş olma.",
      "Tak jileti dudağına şah damarımdan öp beni!"
    ];
    
    module.exports = async (message) => {
        if (message.channel.id === "990091639752130630" && !message.author.bot) {
        iltifatSayi++;
        if (iltifatSayi >= 2) {
          iltifatSayi = 0;
